...
| `bitcoin/` | Top-level project directory containing repository-specific resources. |
...
| `daily_main.py` | Top-level file included in the repository. |
...
1. Clone the repository.
   ...
   ```bash
   git clone https://github.com/devMuniz02/btc-hourly-tournament.git
   cd btc-hourly-tournament
   ```
