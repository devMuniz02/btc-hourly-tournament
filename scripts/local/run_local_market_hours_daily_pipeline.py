...
from src.btc_pipeline.path_config import (
    ...
    MARKET_HOURS_DAILY_LOCAL_LOG_PATH,
    ensure_btc_output_dirs,
)


LOG_PATH = MARKET_HOURS_DAILY_LOCAL_LOG_PATH
LAST_PREDICTION_PATH = MARKET_HOURS_DAILY_LAST_PREDICTION_PATH
ARTIFACT_FILES = [
    MARKET_HOURS_DAILY_HISTORY_PATH,
    MARKET_HOURS_DAILY_DASHBOARD_PATH,
    MARKET_HOURS_DAILY_DASHBOARD_REVERSE_PATH,
...
def run_pipeline_once(args: argparse.Namespace) -> tuple[int, bool]:
    ...
    validate_exit_code = run_python_script("src/btc_pipeline/validate_dashboard_market_hours_daily.py")
    ...
    if run_tournament:
        ...
        tournament_exit_code = run_python_script("src/btc_pipeline/market_hours_daily_main.py", tournament_args)
        refresh_exit_code = run_python_script("src/btc_pipeline/validate_dashboard_market_hours_daily.py")
